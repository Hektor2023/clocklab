...
template <uint8_t maxSize>
LimitedSizeString<maxSize>::LimitedSizeString(void)
{
...
template <uint8_t maxSize>
const char *LimitedSizeString<maxSize>::c_str(void)
{
    return array.data();
}

template <uint8_t maxSize>
LimitedSizeString<maxSize> &LimitedSizeString<maxSize>::operator=(const LimitedSizeString<maxSize> &other)
{
...
template <uint8_t maxSize>
bool LimitedSizeString<maxSize>::operator==(LimitedSizeString<maxSize> &rhs) { return strncmp(c_str(), rhs.c_str(), maxSize) == 0; }
